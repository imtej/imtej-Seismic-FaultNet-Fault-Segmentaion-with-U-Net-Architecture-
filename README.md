# Seismic FaultNet: Fault Segmentaion with U-Net (Deep Learning Architecture)


## Seismic FaultNet: using synthetic datasets to train an end-to-end convolutional neural network for 3D seismic fault segmentation

**This is a [Keras](https://keras.io/) version of Seismic FaultNe implemented by [Xinming Wu](http://www.jsg.utexas.edu/wu/) for 3D fault segmentation**
